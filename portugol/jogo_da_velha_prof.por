programa {
  ...
  logico vitoria
    ...
    funcao logico verificar_vitoria(){
      ...
      senao se((tabuleiro[1] == tabuleiro[4] e tabuleiro[4] == tabuleiro[7]) ou (tabuleiro[2] == tabuleiro[5] e tabuleiro[5] == tabuleiro[8]) ou (tabuleiro[3] == tabuleiro[6] e tabuleiro[6] == tabuleiro[9])){
        vencedor = verdadeiro
      }
      senao se((tabuleiro[0] == tabuleiro[4] e tabuleiro[4] == tabuleiro[9]) ou (tabuleiro[3] == tabuleiro[5] e tabuleiro[5] == tabuleiro[7])){
        vencedor = verdadeiro
      }
